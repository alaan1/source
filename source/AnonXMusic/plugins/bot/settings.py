...
async def command_bot(c,cq):
    if cq.message.chat.type == ChatType.PRIVATE:
        return await cq.edit_message_text(
            "• اوامر التشغـيل◟\n• شغل او تشغيل ، لـ تشغـيل الموسيقي◟  \n• فيد او فيديو  ، لـ تشغـيل مقطع فيديو◟ \n• حمل + اسم الفيديو ، لـ تحميل مقطع فيديو◟\n• نزل + اسم الاغنية ، لـ تحميل ملف صوتي◟ \n• تفعيل الاذان ، لـ تفعيل الاذان فـ المحادثة◟\n• سورس ، لعرض معلومات البوت◟\n\n• الـمطور : @z0hary",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text=". ReTuRn .",callback_data=f"settingsback_helper",)],]),
        )
